            ...
            <div className="container regulations">
                <div className="row justify-content-md-center">
                    ...
                    <div className="col-md-7 my-5">
                        ...
                        <p className="text-justify">2.3.	<span className="font-weight-bold">Zarządzający Serwisem</span> — podmiot świadczący usługę udostępnienia zasobów Serwisu na rzecz Użytkowników, którym jest firma MP NEW sp. z o.o. w RZESZOWIE z siedzibą w Rzeszowie przy ul. Tulipanowej 22; REGON: 367543704; NIP: 8161705454; KRS: 0000682921.</p>
                    ...
                    <div className="col-md-7 my-5">
                        <p className="text-justify">3.1	Właścicielem Serwisu jest firma MP NEW sp. z o.o. w RZESZOWIE z siedzibą w Rzeszowie przy ul. Tulipanowej 22; REGON: 367543704; NIP: 8161705454; KRS: 0000682921.</p>
                    ...
                    <div className="col-md-7 my-5">
                        ...
                        <p className="text-justify">5.2	Zarządzający Serwisem danych osobowych to firma MP NEW sp. z o.o. w RZESZOWIE z siedzibą w Rzeszowie przy ul. Tulipanowej 22, która dokonuje przetwarzania danych osobowych Użytkowników zgodnie z przepisami ustawy z dnia 29 sierpnia 1997 roku o ochronie danych osobowych (t. jedn. Dz.U. z 2002 r., nr 101, poz. 926 ze zm.) oraz ustawy z dnia 18 lipca 2002 roku o świadczeniu usług drogą elektroniczną (Dz.U. nr 144, poz. 1204 ze zm.).</p>
